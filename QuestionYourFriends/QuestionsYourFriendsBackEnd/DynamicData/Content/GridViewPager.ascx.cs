...
namespace QuestionsYourFriendsBackEnd
{
    public partial class GridViewPager : System.Web.UI.UserControl
    {
        ...
        protected void DropDownListPageSize_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                //si l'index de page a changé, cela signifie que la page précédente n'était pas valide et qu'elle a été corrigée. Effectuez à nouveau la liaison pour remplir le contrôle avec la page corrigée
                _gridView.DataBind();
            }
        }
