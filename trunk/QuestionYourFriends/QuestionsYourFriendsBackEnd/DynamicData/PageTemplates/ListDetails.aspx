<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="ListDetails.aspx.cs" Inherits="QuestionYourFriendsBackEnd.DynamicData.PageTemplates.ListDetails" %>
            ...
            <asp:Panel ID="DetailsPanel" runat="server">
                ...
                <asp:FormView ID="FormView1" runat="server" DataSourceID="DetailsDataSource" RenderOuterTable="false"
                    ...
                    <ItemTemplate>
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:LinkButton runat="server" CommandName="Edit" Text="Modifier" />
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Supprimer"
                                    OnClientClick='return confirm("Are you sure you want to delete this item?");' />
                                <asp:LinkButton runat="server" CommandName="New" Text="Nouveau" />
                            </td>
                        </tr>
                    </ItemTemplate>
                    <EditItemTemplate>
